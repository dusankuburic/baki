...
`)
	...
	fmt.Fprintf(&sb, "<h1>Flow Analysis: %s</h1>\n", html.EscapeString(report.FlowID))
	fmt.Fprintf(&sb, "<div class=\"meta\">Flow ID: %s &middot; Generated: %s</div>\n",
		html.EscapeString(report.FlowID),
	...
	fmt.Fprintf(&sb, `<div class="stat"><div class="stat-label">Errors</div><div class="stat-value errors">%d</div></div>`, report.Stats.Errors)
	fmt.Fprintf(&sb, `<div class="stat"><div class="stat-label">Warnings</div><div class="stat-value warnings">%d</div></div>`, report.Stats.Warnings)
	fmt.Fprintf(&sb, `<div class="stat"><div class="stat-label">Info</div><div class="stat-value info">%d</div></div>`, report.Stats.Info)
	total := report.Stats.Errors + report.Stats.Warnings + report.Stats.Info
	fmt.Fprintf(&sb, `<div class="stat"><div class="stat-label">Total</div><div class="stat-value">%d</div></div>`, total)
	sb.WriteString(`</div>`)
...
`)
		for _, f := range report.Findings {
			...
			fmt.Fprintf(&sb, `<tr><td><span class="severity %s">%s</span></td><td><span class="category">%s</span></td><td>%s</td><td>%s</td><td>%s</td></tr>`+"\n",
				sevClass,
	...
	fmt.Fprintf(&sb, `<div class="footer">Generated by PAD Analyzer &middot; %d rules executed &middot; %d blocks analyzed</div>`,
