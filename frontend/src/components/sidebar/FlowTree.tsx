...
export default function FlowTree({
    ...
    }, [rows, focusedIndex, expandedSubflowIds, expandedBlockIds, onToggleSubflowExpand, onToggleBlockExpand, onSelectBlock, onSelectSubflow])
        ...
        >
            <div style={{height: totalHeight, position: 'relative'}}>
                {visibleRows.map((row, i) => {
                    ...
                    const isSelected = row.kind === 'subflow'
                        ? selectedSubflowId === row.id
                        : selectedBlockId === row.id
                    const isExpanded = row.kind === 'subflow'
                        ? expandedSubflowIds.has(row.id)
                        : expandedBlockIds.has(row.id)
