...
function RecentRow({file, isActive, onSelect, onRemove}: {
    file: RecentFile
    isActive: boolean
    onSelect: (path: string) => void
    onRemove: (path: string) => void
...
export default function RecentFilesMenu({files, anchorRef, onSelect, onRemove, onClear, onClose}: RecentFilesMenuProps) {
