...
export function useCommandList(deps: {
  ...
  return useMemo(() => {
    const cmds: CommandItem[] = [
      ...
      {
        id: 'view.local-map',
        label: 'Local Subflow Map',
        section: 'View',
        shortcut: ['mod', 'shift', 'm'],
        onSelect: () => setMainPaneView('local-map'),
      },
      {
        id: 'view.map',
        label: 'Subflow Map',
      ...
      },
      {
        ...
        section: 'View',
        shortcut: ['mod', '\\'],
        onSelect: () => useEditorStore.getState().splitRight(),
      },
      ...
      },
      {
        ...
        label: 'Export Findings as HTML',
        section: 'Analysis',
        shortcut: ['mod', 'shift', 'h'],
        onSelect: async () => {
          if (!document) return
          try {
            await exportFindingsHTML(document.id)
          } catch (e) {
      ...
      },
      {
        ...
        label: 'Findings: Show All Severities',
        section: 'Analysis',
      ...
      },
      {
        ...
        section: 'Analysis',
        onSelect: () => setMainPaneView('dashboard'),
      },
      ...
      {
        id: 'theme.system',
        label: 'Theme: System (Follow OS)',
        section: 'Appearance',
        onSelect: () => useSettingsStore.getState().updateAppearance({theme: 'system'}),
      },
    ...
    if (user?.role === 'admin') {
      cmds.push({
        ...
        section: 'Navigation',
        onSelect: () => setMainPaneView('admin'),
      })
    }
