...
export const shortcuts: Shortcut[] = [
  ...
  {id: 'file.close.tab', keys: 'mod+w', description: 'Close active tab', category: 'File', scope: 'global'},
  {
    ...
    keys: 'mod+alt+w',
    description: 'Close other tabs in group',
    category: 'File',
    scope: 'global',
  },
  {
    id: 'file.close.all',
    keys: 'mod+shift+w',
    description: 'Close all tabs in group',
    category: 'File',
    scope: 'global',
  },
  ...
  {
    id: 'view.move.group.right',
    keys: 'mod+alt+right',
    description: 'Move tab to next group',
    category: 'View',
    scope: 'global',
  },
  {
    id: 'view.move.group.left',
    keys: 'mod+alt+left',
    description: 'Move tab to previous group',
    category: 'View',
    scope: 'global',
  },
  ...
  {id: 'nav.first.child', keys: 'mod+down', description: 'First child', category: 'Navigation', scope: 'main'},
  {
    id: 'nav.up.subflow',
    keys: 'mod+shift+up',
    description: 'Up to parent subflow',
    category: 'Navigation',
    scope: 'global',
  },
  ...
  {id: 'ai.next.suggestion', keys: 'tab', description: 'Next suggested prompt', category: 'AI', scope: 'chat'},
  {
    id: 'ai.cancel.stream',
    keys: 'escape',
    description: 'Cancel AI response',
    category: 'AI',
    scope: 'chat',
    preventDefault: false,
  },
  ...
  {
    id: 'analysis.export.html',
    keys: 'mod+shift+h',
    description: 'Export findings as HTML',
    category: 'Analysis',
    scope: 'global',
  },
  // mod+alt+e: mod+shift+e belongs to file.export.md (declared in App.tsx).
  {
    id: 'analysis.export.csv',
    keys: 'mod+alt+e',
    description: 'Export findings as CSV',
    category: 'Analysis',
    scope: 'global',
  },
  {
    id: 'analysis.filter.errors',
    keys: 'mod+shift+1',
